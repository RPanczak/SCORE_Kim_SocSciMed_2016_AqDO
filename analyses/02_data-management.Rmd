...
Method of Ng basically takes into accoutn answers to five questions and follows a flowchart to assign the individual to a risk category ranging from 0 to 4.  
...
```{r include=FALSE}
rm(bus_1, b3b_cd3, b1_ks2, b3b_kk1, b1_pp, b3a_dl1, b3b_rj3, b3a_si,
...
```{r echo=FALSE}
data %>% 
  select(-risk1, -risk2, -time1, -time2) %>% 
  select(-hhid07_9, -hhid07, - pid07) %>% 
...
frq(data %>% filter(underdiagnosed == 0), bp_month2)
