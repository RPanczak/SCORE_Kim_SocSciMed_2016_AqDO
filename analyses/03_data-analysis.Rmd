...
1. Raw data in Stata's dta format are stored in `data-raw` folder (preserving original names; available from the data provider upon registration; stored on OSF project website). Files used to construct final dataset:  
