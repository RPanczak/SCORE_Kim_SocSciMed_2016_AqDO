...
**Note:** *the registration details on the screenshots below have been entered post-analysis.*  
...
The first analysis followed general ideas regarding data preparation and modelling described above but *only selected respondents in poor health*.  

Completed claims: `single-trace`, `21v1on`, `dx1x5w`

## Analysis attepmt 2 

The second analysis *only selected respondents in good health*.  

Completed claims: `ok8kxo`, `n3k3qz`  

## Analysis attepmt 3 

The third analysis *only selected respondents in good health with diagnosed hypertension*.   
...
### Primary & secondary reproduction criteria
...
Ng J (2013) Elicited Risk and Time Preferences: The Role of Demographics, Cognition, and Interviewers. Working paper. University of Southern California. http://static1.1.sqspcdn.com/static/f/884336/20238159/1347396545633/ng_dev_seminar9-10.pdf  
